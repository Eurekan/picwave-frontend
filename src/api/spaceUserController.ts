...
/** getSpaceUserVOList POST /api/spaceUser/list */
export async function getSpaceUserVoListUsingPost(
  body: API.SpaceUserQueryRequest,
  options?: { [key: string]: any }
) {
...
/** getMyTeamSpaceList POST /api/spaceUser/list/my */
export async function getMyTeamSpaceListUsingPost(options?: { [key: string]: any }) {
