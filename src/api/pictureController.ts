...
/** getPictureListByPage POST /api/picture/list/page */
...
/** getPictureVOListByPage POST /api/picture/list/page/vo */
export async function getPictureVoListByPageUsingPost(
  body: API.PictureQueryRequest,
  options?: { [key: string]: any }
) {
...
/** getPictureVOListByPageWithCache POST /api/picture/list/page/vo/cache */
...
/** getPictureTagCategoryList GET /api/picture/tag_category */
export async function getPictureTagCategoryListUsingGet(options?: { [key: string]: any }) {
